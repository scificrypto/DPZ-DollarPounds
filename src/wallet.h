...
enum WalletFeature
{
    FEATURE_BASE = 70503, // the earliest version new wallets supports (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 70502, // wallet encryption
    FEATURE_COMPRPUBKEY = 70502, // compressed public keys

    FEATURE_LATEST = 70503
};
